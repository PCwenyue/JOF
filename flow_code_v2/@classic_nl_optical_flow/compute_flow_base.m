...
%         end
        ...
        if ~isempty(this.median_filter_size)
            ...
            [~, u] = mutual_structure_joint_filtering(u, v , r, eps_I, eps_G, lambda_I, lambda_G, maxiter);
            [~, v] = mutual_structure_joint_filtering(u, v , r, eps_I, eps_G, lambda_I, lambda_G, maxiter);
            uv = cat(3,u,v);
