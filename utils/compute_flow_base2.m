function uv = compute_flow_base2(this, uv, weightx, weighty)
%%
...
% THIS SOFTWARE.        
  ...
  for i = 1:this.max_iters
    ...
    for j = 1:this.max_linear       
        ...
        if this.alpha == 1
            [A, b, parm, iterative] = ...
                flow_operator2(qua_this, uv, duv, It, Ix, Iy, weightx, weighty);        
            
        elseif this.alpha > 0
            [A, b] = ...
                flow_operator2(qua_this, uv, duv, It, Ix, Iy, weightx, weighty);        
            [A1, b1, parm, iterative] = ...
                flow_operator2(this, uv, duv, It, Ix, Iy, weightx, weighty);        
        ...
        % Print status information (change between flow increment = flow
